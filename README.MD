...
1. **Clone the repository** (optional, if developing):
   ```bash
   git clone https://github.com/rxdsec/rxdsec.git
   cd rxdsec
   ```
...
**RxDsec CLI** - Your privacy-focused, fully local AI coding assistant ✨